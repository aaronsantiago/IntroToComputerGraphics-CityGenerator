...
var onKeyUp = function (event) {
  let iframe = {};
    switch (event.key) {
      case "1":
        Pos = new THREE.Vector3(0, 200, 160);
        TargetDir = new THREE.Vector3(50,0,-100);
        iframe = document.getElementsByTagName("iframe")[0];
        iframe.src = iframe.src;
        break;
      case "2":
        Pos = new THREE.Vector3(-50, 300, 0);
        TargetDir = new THREE.Vector3(0,0,0);
        iframe = document.getElementsByTagName("iframe")[0];
        iframe.src = iframe.src;
        break;
      case "3":
        Pos = new THREE.Vector3(45, 100, 320);
        TargetDir = new THREE.Vector3(0,100,0);
        iframe = document.getElementsByTagName("iframe")[0];
        iframe.src = iframe.src;
        break;
      case "4":
        Pos = new THREE.Vector3(-260, 400, 260);
        TargetDir = new THREE.Vector3(0,0,0);
        iframe = document.getElementsByTagName("iframe")[0];
        iframe.src = iframe.src;
        break;
